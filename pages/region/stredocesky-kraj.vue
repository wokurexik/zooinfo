<template>
    ...
    <Navbar 
        ...
        />
    <div>
        <h1 class="text-center font-extrabold text-5xl mb-11 mt-11">Středočeský kraj</h1>
    </div>
    <div class="map w-[500px]">
        <img class="w-[500px]" src="../../assets/regions/stredocesky.svg" alt="">

        <div class="point rounded-lg has-tooltip top-[100px] left-[300px]">
            <NuxtLink href="../zoo-chleby" >
                <div class="arrow"></div>
